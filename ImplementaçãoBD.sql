...
CREATE TABLE Diario (
    ...
    Obs_Func TEXT,
    Data DATE,
    Horario_Trabalho TIME, -- Horário final do expediente
    Clima VARCHAR(50)
);
...
CREATE TABLE Residuos (
    Classe VARCHAR(50),
    PA_CodPlano INT,
    PRIMARY KEY (Classe, PA_CodPlano),
...
CREATE TABLE Cadastro (
    ...
    FOREIGN KEY (Cad_CodFuncionario) REFERENCES Mao_de_Obra(CodFuncionario)
);
...
CREATE TABLE Contrato (
    ...
    Cont_CodObra INT,
    Cont_CodProp INT,
    PRIMARY KEY (Cont_CodEmpresa, Cont_CodObra, Cont_CodProp),
    FOREIGN KEY (Cont_CodEmpresa) REFERENCES Empresa(CodEmpresa),
    FOREIGN KEY (Cont_CodObra) REFERENCES Obra(CodObra),
    FOREIGN KEY (Cont_CodProp) REFERENCES Proprietario(CodProp)
);
...
CREATE TABLE Trabalho (
    ...
    Trab_CodDiario INT,
    PRIMARY KEY (Trab_CodObra, Trab_CodFuncionario, Trab_CodDiario),
    FOREIGN KEY (Trab_CodObra) REFERENCES Obra(CodObra),
    FOREIGN KEY (Trab_CodFuncionario) REFERENCES Mao_de_Obra(CodFuncionario),
    FOREIGN KEY (Trab_CodDiario) REFERENCES Diario(CodDiario)
);

CREATE TABLE Aluguel (
    Alug_CodEquipamento INT,
    Alug_CodDiario INT,
    Valor DECIMAL(10, 2),
    Periodo INT,
    PRIMARY KEY (Alug_CodEquipamento, Alug_CodDiario),
...
CREATE TABLE Uso (
    ...
    FOREIGN KEY (Uso_Classe) REFERENCES Residuos(Classe)
);

CREATE TABLE Consumo (
    Consume_CodFuncionario INT,
    Consume_CodMaterial INT,
    PRIMARY KEY (Consume_CodFuncionario, Consume_CodMaterial),
    FOREIGN KEY (Consume_CodFuncionario) REFERENCES Mao_de_Obra(CodFuncionario),
    FOREIGN KEY (Consume_COdMaterial) REFERENCES Materiais(CodMaterial)
);

-- Inserção de dados na tabela Empresa
INSERT INTO Empresa (CodEmpresa, CNPJ) VALUES
(1, '12345678000100'),
(2, '12345678000101'),
(3, '12345678000102'),
(4, '12345678000103'),
...
(6, 'Rua Mitocôndria Azul', NULL, '2022-01-17', '2024-12-11'),
...
(1, 'Rua Alexandre de Matos', NULL, 'Construção em Andamento', 'Eletricista terminou a fiação', '2026-10-12', '19:00:00', 'Parcialmente Nublado'),
(2, 'Rua Mitocôndria Azul', NULL, 'Acidente com o Engenheiro', 'Engenheiro conferiu se vai ser necessário levantar a viga do salão, um pedaço de madeira caiu em cima dele.', '2027-01-19', '17:00:00', 'Ensolarado' ),
(3, 'Avenida Trobson Azambuja', NULL, 'Caminhões do concreto chegaram atrasados.', 'Arquiteto conferiu a planta da obra.', '2024-03-06', '16:30:00', 'Chuva Fraca'),
(4, 'Avenida Relâmpago Marquinhos', NULL, 'Problema de filtração no banheiro', 'Pedreiro começou a tirar o rejunte antigo.', '2023-11-17', '17:00:00', 'Nublado'),
(5, 'Avenida Relâmpago Marquinhos', NULL, 'Obra em andamento', 'Arquiteto conferiu a mudança do salão principal.',   '2024-05-19', '18:00:00', 'Nublado'),
(6, 'Avenida F, 213', NULL, 'Obra quase finalizada', 'Engenheiro conferiu a o descarte perigosos.', '2026-01-25', '17:30:00', 'Chuvoso'),
(7, 'Rua Mitocôndria Azul', 'caminho_foto_diario1.jpg', 'N/A', 'Equipe produtiva, bom progresso hoje.', '2023-01-10', '17:00:00', 'Ensolarado'),
(8, 'Avenida B, 456', 'caminho_foto_diario2.jpg', 'Atenção: Vazamento detectado na tubulação principal.', 'Equipe de encanadores acionada.', '2023-02-15', '18:00:00', 'Chuvoso'),
(9, 'Rua Pennywise', 'caminho_foto_diario3.jpg', 'N/A', 'Dia tranquilo, sem incidentes.', '2023-03-20', '17:30:00', 'Nublado'),
(10, 'Avenida D, 101', 'caminho_foto_diario4.jpg', 'Atenção: Atraso na entrega de materiais.', 'Equipe de logística notificada.', '2023-04-25', '18:00:00', 'Ensolarado'),
(11, 'Rua E, 112', 'caminho_foto_diario5.jpg', 'N/A', 'Conclusão da estrutura principal.', '2023-05-30', '16:30:00', 'Parcialmente nublado'),
(12, 'Avenida F, 213', 'caminho_foto_diario6.jpg', 'Atenção: Equipamento danificado.', 'Equipe de manutenção trabalhando no reparo.', '2023-06-05', '17:00:00', 'Chuvoso');
...
-- talvez colocar mais distribuido e aleatorio, com alguns sem cadastro ou contrato >>>>>>> FEITOO
...
INSERT INTO Trabalho (Trab_CodObra, Trab_CodFuncionario, Trab_CodDiario) VALUES
(1, 1, 3),
(6, 2, 2), -- Obra 6: funcionário 2 e 6. Alguns funcionarios irão trabalhar em duas obras diferentes
(2, 3, 4), -- Obra 2: funcionário 3 e 7
(4, 4, 1),
(5, 5, 9),
(6, 6, 7), -- Obra 6: funcionário 2 e 6
(2, 7, 1),  -- Obra 2: funcionário 3 e 7
(8, 8, 8),
(12, 9, 6), -- Obra 12: funcionário 9 e 12
(10, 10, 10),
(11, 11, 11),
(12, 12, 12); -- Obra 12: funcionário 9 e 12

-- Inserção de dados na tabela Aluguel
INSERT INTO Aluguel (Alug_CodEquipamento, Alug_CodDiario,Valor, Periodo) VALUES
(1, 1, 215.00, 30),
(2, 1, 140.00, 20),
(3, 7, 175.00, 15),
(4, 7, 1850.00, 10),
...
INSERT INTO Consumo (Consume_CodFuncionario, Consume_CodMaterial) VALUES
(1, 12),
(2, 11),
(3, 10),
(4, 9),
